...
2. Testing against the dataset of etalon parses serialized into JSON. For them you need https://github.com/nlohmann/json and https://github.com/fileTestSuite/fileTestSuite.c and their dependencies installed and the submodules populated.
